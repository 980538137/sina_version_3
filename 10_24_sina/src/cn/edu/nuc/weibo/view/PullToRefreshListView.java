...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		//添加底部更多View
		mFooterView = (RelativeLayout) mInflater.inflate(R.layout.listfooter_more, this,false);
		tv_more = (TextView) mFooterView.findViewById(R.id.tv_more);
		tv_more.setFocusable(true);
		ll_loading_more = (LinearLayout) mFooterView.findViewById(R.id.ll_loading_more);
